## Grafici a barre andamento nazionale nell'ultima settimana

Di seguito sono riportati i grafici a barre che mostrano l'andamento dei dati della pandemia in Italia nell'**ultima settimana**.

#### Nuovi positivi
![Nuovi positivi](/data/imgs/grafici/andamento-nazionale/07gg/nuovi_positivi.png)

#### Rapporto nuovi positivi / nuovi tamponi
![Nuovi positivi su nuovi tamponi](/data/imgs/grafici/andamento-nazionale/07gg/nuovi_positivi_su_nuovi_tamponi.png)
...
![Terapia intensiva su totale ospedalizzati](/data/imgs/grafici/andamento-nazionale/07gg/terapia_intensiva_su_totale_ospedalizzati.png)

#### Totale degli ospedalizzati
![Terapia ospedalizzati](/data/imgs/grafici/andamento-nazionale/07gg/totale_ospedalizzati.png)

#### Rapporto ospedalizzati / totale positivi
![totale ospedalizzati su totale positivi](/data/imgs/grafici/andamento-nazionale/07gg/totale_ospedalizzati_su_totale_positivi.png)

#### Nuovi deceduti
![Nuovi deceduti](/data/imgs/grafici/andamento-nazionale/07gg/nuovi_deceduti.png)
